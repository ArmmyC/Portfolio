...
export function Recognition() {
  return (
    <section id="recognition" className="editorial-section scroll-mt-24 py-16 lg:py-20">
      ...
      <p className="reveal mb-6 text-[16px] leading-relaxed text-muted-foreground md:text-[17px]">A few credentials and moments along the way.</p>
        ...
        {RECOGNITION.map((r) => (
          <li key={r.title} className="reveal relative">
            ...
            <div className="flex flex-wrap items-baseline gap-x-2.5 gap-y-1">
              <span className="font-mono text-[13px] text-primary">{r.year}</span>
